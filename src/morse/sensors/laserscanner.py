    ...
    **Hokuyo** and a **SICK LD-MRS**. The example below shows how to add them
    ...
    def default_action(self):
        ...
        for ray in self._ray_list:
            ...
            #  of the sensor
            correct_ray = self.position_3d.matrix @ ray if blenderapi.using_upbge() else self.position_3d.matrix * ray
            ...
            if target:
                ...
                new_point = inverse @ point if blenderapi.using_upbge() else inverse * point
