...
class Accelerometer(morse.core.sensor.Sensor):
    ...
    def _sim_physics(self):
        ...
        self.a = w2a @ (self.robot_vel - self.plv) / self.dt if blenderapi.using_upbge() else w2a * (self.robot_vel - self.plv) / self.dt
        ...
        self.local_data['velocity'] = w2a @ self.robot_vel if blenderapi.using_upbge() else w2a * self.robot_vel 
